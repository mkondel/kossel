...
motor_shaft = 0.0;	// NEMA17 motor shaft exact diameter = 5
m3_dia = 0.0;		// 3mm hole diameter
m3_nut_hex = 1;		// 1 for hex, 0 for square nut
m3_nut_flats = 0.0;	// normal M3 hex nut exact width = 5.5
m3_nut_depth = 0.0;	// normal M3 hex nut exact depth = 2.4, nyloc = 4
...
pulley_b_ht = 6.5;		// pulley base height, standard = 8. Set to same as idler_ht if you want an idler but no pulley.
